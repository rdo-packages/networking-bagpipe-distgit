...
%{?dlrn: %global tarsources python-networking-bagpipe}
%{!?dlrn: %global tarsources python_networking_bagpipe}
...
%changelog
* Mon Mar 17 2025 RDO <dev@lists.rdoproject.org> 22.0.0-0.1.0rc1
