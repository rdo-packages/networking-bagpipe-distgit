...
%{?dlrn: %global tarsources networking-bagpipe}
%{!?dlrn: %global tarsources networking_bagpipe}
...
Source0:        http://tarballs.openstack.org/%{pypi_name}/%{tarsources}-%{upstream_version}.tar.gz
Source1:        %{servicename}.service
# Required for tarball sources verification
%if 0%{?sources_gpg} == 1
Source101:        http://tarballs.openstack.org/%{pypi_name}/%{tarsources}-%{upstream_version}.tar.gz.asc
...
%changelog
# REMOVEME: error caused by commit https://opendev.org/openstack/networking-bagpipe/commit/54ddcb0721993aa9e5c13e0eeb097d6b9b8bd4b1
